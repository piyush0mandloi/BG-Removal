  ...
  return (
    <div className='flex items-center justify-between max-sm:flex-col-reverse gap-y-10 px-4 mt-10 lg:px-44 sm:mt-20'>
        ...
        <div >
            ...
            <p className='my-6 text-[15px] text-gray-500'>Lorem ipsum, dolor sit amet consectetur emque quisquam aute <br className='max-md:hidden'/>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Rerum provident sunt dolorem velit, quos.</p>
            <div>
